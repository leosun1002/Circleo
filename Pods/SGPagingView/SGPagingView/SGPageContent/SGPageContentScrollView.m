...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    if (self.delegatePageContentScrollView && [self.delegatePageContentScrollView respondsToSelector:@selector(pageContentScrollViewDidEndDecelerating:index:)]) {
        [self.delegatePageContentScrollView pageContentScrollViewDidEndDecelerating:self index:index];
    }
}
