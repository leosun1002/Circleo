...
-(void)setTagWithTagArray:(NSArray*)arr{
    ...
    previousFrame = CGRectMake(XMGDefaultEdgeInsets.left, XMGDefaultEdgeInsets.top, 0, 0);
    [arr enumerateObjectsUsingBlock:^(NSString*str, NSUInteger idx, BOOL *stop) {
        ...
        tag.textColor = [UIColor colorWithRGBHex:@"#323236"];
        tag.font = [UIFont systemFontOfSize:13 weight:(UIFontWeightSemibold)];
        tag.text = str;
        ...
        if(self->_signalTagColor){
            ...
            tag.layer.borderColor = [UIColor colorWithRGBHex:@"#DFE2E6"].CGColor;
