...
#import "ZWTagListView1.h"
#define HORIZONTAL_PADDING 0.f
#define VERTICAL_PADDING   1.f
static const CGFloat XMGDefaultColumnMargin = 10;
static const CGFloat XMGDefaultRowMargin = 0;
static const UIEdgeInsets XMGDefaultEdgeInsets = {0, 0, 0, 0};

@interface ZWTagListView1(){
...
-(void)setTagWithTagArray:(NSArray*)arr{
    ...
    [arr enumerateObjectsUsingBlock:^(NSString*str, NSUInteger idx, BOOL *stop) {
        ...
        UILabel *line = [[UILabel alloc] initWithFrame:CGRectMake(0, Size_str.height - 1, Size_str.width, 1)];
